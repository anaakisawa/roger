...
class AboutMethods < EdgeCase::Koan
  ...
  #a + b
  #end
  #my_global_method(2,3) => 5 - ele vai retornar meu método só por eu 
  #chamar o nome dele passando doi valores (nesse caso) como parâmetro
  ...
  def test_calling_global_methods_without_parenthesis
    result = my_global_method 2, 3 #o método funciona sem parênteses tb
  ...
  def method_with_defaults(a, b=3) # 3 é o valor default do b
    [a, b]
  end

  def test_calling_with_default_values
    assert_equal [1, 3], method_with_defaults(1)
